Pod::Spec.new do |spec|
    spec.name                   = 'NimbusMobileFuseKit'
    spec.version                = '0.0.1-development'
    spec.summary                = 'Enables MobileFuse bidding through Nimbus'
    ...
    spec.source_files           = "Sources/NimbusMobileFuseKit/**/*.swift"
    spec.source                 = {
        :git => "https://github.com/adsbynimbus/nimbus-ios-mobilefuse.git", 
        :tag => spec.version.to_s
    }

    spec.dependency 'NimbusSDK/NimbusKit', '~> 3'
    spec.dependency 'MobileFuseSDK', '~> 1.9'
end
